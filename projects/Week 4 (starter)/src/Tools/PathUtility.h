...
namespace nou
{
	...
	public:
		...
		typedef std::function<glm::vec3(const glm::vec3&, const glm::vec3&, float)>SegmentInterpolator;

		typedef std::function<glm::vec3(const glm::vec3&, const glm::vec3&, const glm::vec3&, const glm::vec3&, float)>CurveInterpolator;
		...
		static SegmentInterpolator Lerp;
