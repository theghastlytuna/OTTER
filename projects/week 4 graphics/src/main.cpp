...
int main() {
	...
	static const GLfloat ultraPoints[] = {
		-0.5f, -0.5f, 0.5f,
		0.5f, -0.5f, 0.5f,
		0.0f, 0.5f, 0.5f
	};
	...
	VertexBuffer::Sptr ultraPosVbo = VertexBuffer::Create();
	ultraPosVbo->LoadData(ultraPoints, 9);

	VertexArrayObject::Sptr vao3 = VertexArrayObject::Create();
	vao3->AddVertexBuffer(ultraPosVbo, {
		BufferAttribute(0, 3, AttributeType::Float, 0, NULL)
		});
	vao3->AddVertexBuffer(color_vbo, {
		{ 1, 3, AttributeType::Float, 0, NULL }
		});
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(glm::sin(static_cast<float>(thisFrame)), 0.0f, 0.f));
